...
In this project, two fully reproducible models are designed for binary classification of particle-physics events, with the objective of distinguishing rare signal (s) events from background (b) events. The main goal is to:
